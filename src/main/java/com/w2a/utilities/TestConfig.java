...
public class TestConfig{
	...
	public static String from = "ashwin.karkera28@gmail.com";
	public static String password = "twostates@123";
	public static String[] to = {"ashwin.karkera28@gmail.com"};//{"seleniumcoaching@gmail.com","trainer@way2automation.com"};
